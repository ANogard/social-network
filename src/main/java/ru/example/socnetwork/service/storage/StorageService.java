package ru.example.socnetwork.service.storage;
...
import ru.example.socnetwork.service.LocalFileService;
...
public class StorageService {
  ...
  @Scheduled(cron = "${example.app.cronUploadLogFiles}")
  ...
  @Scheduled(cron = "${example.app.cronDeleteLogFolderInRemoteStorage}")
